...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sushi Lovers Nahariya — суши с доставкой" },
      {
        name: "description",
        content:
          "Sushi Lovers Нагария: свежие роллы, нигири и сеты. Доставка в Нагарию, Акко и Маалот, самовывоз, заказ через WhatsApp.",
      },
      { property: "og:title", content: "Sushi Lovers Nahariya" },
      {
        property: "og:description",
        content: "Свежие суши и роллы в Нагарии. Доставка и самовывоз, заказ в WhatsApp.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Heebo:wght@300..800&family=Inter:wght@300..800&family=Playfair+Display:wght@500;600;700;800&display=swap",
      },
